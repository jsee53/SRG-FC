    ...
    <>
      ...
      <div className="px-4 pb-3">
        <button
          ...
          className="w-full rounded-full bg-emerald-400 py-2.5 text-sm font-semibold text-emerald-950 transition-colors hover:bg-emerald-300 disabled:opacity-40 disabled:hover:bg-emerald-400"
        >
          팀 나누기
        </button>
        {!canGenerate && (
