...
// - role은 동호회 직책 칭호입니다: captain(주장) | viceCaptain(부주장) | manager(총무) | creator(제작자). 없으면 생략.
...
export const members = [
  ...
  { id: 3, name: '최현규', number: 6, birthYear: 1998, positions: ['MF', 'DF'], tier: 'S', rank: 3, photo: '', intro: '뚫을 수 없는 플레이어', stats: { passing: 87, dribbling: 87, physical: 98, defense: 99, stamina: 99, finishing: 88 } },
  { id: 4, name: '한상혁', number: 8, birthYear: 1998, positions: ['MF', 'FW', 'DF'], tier: 'S', rank: 4, photo: '', role: 'viceCaptain', intro: '육각형 플레이어', stats: { passing: 98, dribbling: 96, physical: 82, defense: 93, stamina: 97, finishing: 85 } },
  ...
  // A 티어
  { id: 7, name: '진시영', number: 1, birthYear: 1999, positions: ['FW'], tier: 'A', rank: 1, photo: '', role: 'creator', intro: '주사위형 플레이어', stats: { passing: 75, dribbling: 86, physical: 92, defense: 84, stamina: 86, finishing: 93 } },
  { id: 8, name: '박주성', number: 10, birthYear: 1999, positions: ['MF', 'DF'], tier: 'A', rank: 2, photo: '', role: 'captain', intro: 'S급 서포터', stats: { passing: 94, dribbling: 79, physical: 76, defense: 91, stamina: 90, finishing: 80 } },
  ...
  { id: 15, name: '최종범', number: null, birthYear: 1999, positions: ['MF'], tier: 'B', rank: 3, photo: '', role: 'manager', intro: '중원의 정령', stats: { passing: 85, dribbling: 74, physical: 73, defense: 84, stamina: 75, finishing: 71 } },
  ...
  // C 티어
  { id: 19, name: '편현재', number: 4, birthYear: 1999, positions: ['MF'], tier: 'C', rank: 1, photo: '', intro: '슛돌이', stats: { passing: 71, dribbling: 69, physical: 70, defense: 73, stamina: 74, finishing: 75 } },
  ...
  { id: 22, name: '박형진', number: null, birthYear: 1998, positions: ['MF'], tier: 'C', rank: 4, photo: '', intro: '신규 플레이어', stats: { passing: 63, dribbling: 77, physical: 65, defense: 66, stamina: 76, finishing: 67 } },
  ...
  // D 티어
  { id: 25, name: '조병찬', number: 22, birthYear: 1999, positions: ['GK', 'DF'], tier: 'D', rank: 1, photo: '', intro: '절대적 플레이어 라이벌', stats: { passing: 64, dribbling: 63, physical: 62, defense: 75, stamina: 61, finishing: 65 } },
