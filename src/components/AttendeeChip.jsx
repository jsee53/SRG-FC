  ...
  return (
    <button
      ...
      className={`relative flex items-center gap-2 rounded-xl p-2 text-left transition-all ${
        selected
          ? 'bg-emerald-500/20 ring-2 ring-emerald-400/70'
    ...
    >
      ...
      {selected && (
        <span className="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-emerald-400/80 text-[10px] font-bold text-emerald-950">
          ✓
        </span>
      )}
    </button>
